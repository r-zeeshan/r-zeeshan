...
const quotes = [
  ...
  {
    text: 'I worked with Zeeshan for eight months on multiple AI-driven healthcare applications, and he was a reliable and highly capable development partner throughout. Strong ownership, clear communication, and a solid understanding of product goals beyond just implementation. I would recommend him to any team as a true product partner.',
    author: 'Health-tech founder',
    role: '8-month partnership',
  },
  {
